@rem Optimize NextGen v3.7
@rem Written by ThDub @ResonantStep - 05/06/2019
...
:Check_Caption
	...
	set "Shell_Title=[97m]0;Optimize Next Gen v3.7 LITE[97m"
	echo %Shell_Title%
	cls
...
:Inferior_Build
	set "Shell_Title=[97m]0;Optimize Next Gen v3.7[97m"
	echo %Shell_Title%
...
::============================================================================================================
	...
	if "%Run%" == "First" (
		...
		if "%SecretMode%" == "Unlocked" (
			"%Tmp_Folder%Files\Utilities\NSudoC.exe" -U:P -ShowWindowMode:Hide "%Tmp_Folder%Optimize_NextGen_v3.7_MDL.bat" && exit /b
		)  else (
			"%Tmp_Folder%Files\Utilities\NSudoC.exe" -U:P -ShowWindowMode:Show "%Tmp_Folder%Optimize_NextGen_v3.7_MDL.bat" && exit /b
		)
	)
...
:: Make PS Script
	@echo $host.ui.RawUI.WindowTitle =  "Optimize Next Gen v3.7 | Powershell Script">>%scriptname%
