...
:: TitleBar
	set "Shell_Title=[97m]0;Optimize Next Gen v3.9.5[97m"
...
:Check_Caption
	...
	set "Shell_Title=[97m]0;Optimize Next Gen v3.9.5 LITE[97m"
...
:: Launch script from temp folder
	if "%Run%" == "First" (
		...
		if "%SecretMode%" == "Unlocked" (
			"%Tmp_Folder%Files\Utilities\NSudoC.exe" -U:P -ShowWindowMode:Hide "%Tmp_Folder%Optimize_NextGen_v3.9.5_MDL.bat" && exit /b ) else (
			"%Tmp_Folder%Files\Utilities\NSudoC.exe" -U:P -ShowWindowMode:Show "%Tmp_Folder%Optimize_NextGen_v3.9.5_MDL.bat" && exit /b ))
...
::============================================================================================================
	...
	if not "%FullMode%" == "Unlocked" ( echo: & echo:
...
:: Make PS Script
	@echo $host.ui.RawUI.WindowTitle = "Optimize Next Gen v3.9.5 | Powershell Script">>%Idx_scriptname%
...
::============================================================================================================
	...
	cd /d "%Tmp_Folder%"
	robocopy /MIR "%TEMP%\SettingsBackup" "%launchpath%Backup" >nul 2>&1
